 ...
 *
 * ⚠️ أي جدول هيخزّن نص مشفّر مربوط بـ AAD لازم يكون مفتاحه BigInt
 * مربوط بـ sequence. ممنوع UUID أو معرّف بيتولد في التطبيق.
 */
...
/** مفتاح جدول حسابات الدفع — أول مستهلك للخدمة (المرحلة 1b.1) */
export const PAYMENT_ACCOUNTS_TABLE = 'payment_accounts'

export const PAYMENT_INTENTS_TABLE = 'payment_intents'

export const RESERVABLE_TABLES: Record<string, ReservableTable> = {
  [PAYMENT_ACCOUNTS_TABLE]: { table: 'payment_accounts', column: 'id' },
  [PAYMENT_INTENTS_TABLE]: { table: 'payment_intents', column: 'id' },
}
